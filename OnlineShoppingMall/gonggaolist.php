...
&nbsp;条&nbsp;每页显示&nbsp;<?php echo $pagesize;?>&nbsp;条&nbsp;第&nbsp;<?php echo $page;?>&nbsp;页/共&nbsp;<?php echo $pagecount; ?>&nbsp;页
        <?php
		  ...
		  {
		  ?>
        <a href="gonggaolist.php?page=1" title="首页"><font face="webdings"> 9 </font></a> <a href="gonggaolist.php?id=<?php echo $id;?>&amp;page=<?php echo $page-1;?>" title="前一页"><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
        ...
        <a href="gonggaolist.php?page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php }?>
        <a href="gonggaolist.php?page=<?php echo $page-1;?>" title="后一页"><font face="webdings"> 8 </font></a> <a href="gonggaolist.php?id=<?php echo $id;?>&amp;page=<?php echo $pagecount;?>" title="尾页"><font face="webdings"> : </font></a>
        <?php }?>
            </div></td>
        </tr>
      </table>
