  ...
  <tr>
    <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#66CCFF" bgcolor="#FFFFFF" >
      ...
      <?php if ($totalRows_rs_bbs > 0) { // Show if recordset not empty ?>
        <?php do { ?>
          <tr>
            ...
            <td height="40"><a href="content.php?bbs_id=<?php echo $row_rs_bbs['bbs_ID']; ?>"><?php echo $row_rs_bbs['bbs_Title']; ?></a></td>
      ...
      <?php if ($totalRows_rs_bbs == 0) { // Show if recordset empty ?>
        <tr>
          <td height="20" colspan="7">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE26">目前没有发表任何主题 </span></td>
        </tr>
        <?php } // Show if recordset empty ?>
<tr>
  <td height="40" colspan="7" bgcolor="#4DAFFE"><span class="STYLE28">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Copyright @ 2012 www.hbculture.com Inc.All rights reserved. PHP论坛管理系统    </span></td>
</tr>
    </table></td>
  </tr>
</table>
