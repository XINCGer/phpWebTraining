...
<body>
    <form id="form1" runat="server" action="./registerdo.php" method="post">
    <div class="Main">
        <ul>
            <li class="top"></li>
            <li class="top2"></li>
            ...
            <li class="middle_C"><span class="btn"><input name="" type="image" src="images/login/register.gif" /></span></li>
